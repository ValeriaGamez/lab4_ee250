...
def on_connect(client, userdata, flags, rc):
    ...
    client.subscribe("vgamez")
    client.subscribe("Date")
    client.subscribe("Time")
        
    #Add the custom callbacks by indicating the topic and the name of the callback handle
    client.message_callback_add("vgamez", on_message_from_ipinfo)

    client.message_callback_add("Date", on_message_from_date)

    client.message_callback_add("Time", on_message_from_time)
